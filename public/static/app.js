...
async function loadSystemDetail() {
  ...
  if (d.items && d.items.length > 0) {
    ...
    html += '<div class="overflow-auto border border-gray-100 rounded-lg" style="height:38vh; min-height:240px;"><table class="data-table"><thead><tr><th>管理番号</th><th>案件名</th><th>期</th><th class="num">計画</th><th class="num">見通し</th><th class="num">実績</th><th class="num">差異</th></tr></thead><tbody>';
