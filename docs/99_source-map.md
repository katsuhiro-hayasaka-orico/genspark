...
|---|---|---|---|
| 画面DOM基準のPDF/HTML出力 | `public/static/app.js`, `public/static/style.css` | `ensureExportableView`, `renderExportControls`, `exportCurrentView`, `waitForChartsReady`, `buildStandaloneHtml` | `#export-root` の現在DOMを出力対象にする。 |
