...
グローバルフィルター（対象期間、部署、分析視点等）を利用します。対象期間はコンパクトなトリガーからポップオーバーを開き、当月・前月・当期累計・前期通期・直近3か月・直近12か月・データ最新月・カスタム範囲を選択します。カスタム範囲では対象月または対象期の開始/終了を指定します。対象期は67期=2026年4月〜2027年3月、66期=2025年4月〜2026年3月として月範囲へ展開し、選択範囲の月次データだけを累計します。差額ランキングは差額絶対値または差額の大きい順で表示される実装です。
